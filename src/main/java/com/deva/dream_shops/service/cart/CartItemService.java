...
import com.deva.dream_shops.repository.CartItemRepository;
import com.deva.dream_shops.repository.CartRepository;
...
public class CartItemService implements ICartItemService{
    ...
    public void addItemToCart(Long cartId, Long productId, int quantity) {
        ...
        //5.If no, then add the product to the cart
